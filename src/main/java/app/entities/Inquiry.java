...
public class Inquiry {
    ...
    public Inquiry(int inquiryId, int customerId, int carportLength, int carportWidth, String roofType, int slopeRoof, String siding, int shedLength, int shedWidth, Date date) {

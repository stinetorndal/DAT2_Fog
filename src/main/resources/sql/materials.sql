...
VALUES ('25x200 mm. trykimp. Brædt', 360, 'understernbrædder til for & bag ende', 'Stk', 120.00),
       ...
       ('45x195 mm. spærtræ ubh.', 300, 'Remme i sider, sadles ned i stolper', 'Stk', 300.00),
       ('45x195 mm. spærtræ ubh.', 360, 'Remme i sider, sadles ned i stolper', 'Stk', 360.00),
       ('45x195 mm. spærtræ ubh.', 540, 'Remme i sider, sadles ned i stolper', 'Stk', 540.00),
       ('45x195 mm. spærtræ ubh.', 300, 'Spær, monteres på rem', 'Stk', 300.00),
